<?php
    ...
    new class extends Component {
        ...
        public function minutaEdit(\App\Models\Minuta $minuta): void
        {
            ...
            $this->productoId   = $this->minuta->producto_id;
            ...
            $this->anioDesde            = $this->minuta->anio_desde;
            $this->anioHasta            = $this->minuta->anio_hasta;
            $this->periodocantidad      = $this->minuta->anio_cantidad;
        ...
        public function grabarMinuta()
        {
            ...
            $this->minuta->anio_desde            = $this->anioDesde;
            $this->minuta->anio_hasta            = $this->anioHasta;
            $this->minuta->anio_cantidad         = $this->periodocantidad;
            ...
            $this->reset();
            Flux::modal('minuta-editar-modal')->close();
        ...
        {
            $this->reset();
            Flux::modal('minuta-editar-moda')->close();
            $this->dispatch('refreshComponent')->to('pages::minutas.formularios.index');
        }
...
<div>
    <flux:modal name="minuta-editar-modal" class="min-w-[64rem]">
